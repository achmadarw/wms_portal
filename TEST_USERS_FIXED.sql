...
-- 
-- IMPORTANT NOTES:
-- - SUPERVISOR: assigned to warehouse via warehouseId AND set as manager via Warehouse.managerId
-- - OPERATOR: assigned to warehouse via warehouseId only (NOT set as manager)
-- - Each warehouse can have 1 manager (SUPERVISOR) and multiple operators
-- ============================================================
...
-- Set Tom as Surabaya warehouse manager
UPDATE "Warehouse" SET managerId = 'supervisor-sby-001' WHERE id = 'WH-SBY-001';
...
-- Set David as Bandung warehouse manager
UPDATE "Warehouse" SET managerId = 'supervisor-bdg-001' WHERE id = 'WH-BDG-001';
