            ...
            <div className='bg-gradient-to-r from-amber-600 to-amber-700 rounded-2xl shadow-xl p-8 text-white'>
                <div className='flex items-center justify-between'>
                    ...
                    <div className='flex gap-3'>
                        {/* RBAC: ADMIN can create anywhere, SUPERVISOR can create in assigned warehouse */}
                        {(userRole === 'ADMIN' ||
                            (userRole === 'SUPERVISOR' &&
                            ...
                            {paginatedBins.length === 0 ? (
                                ...
                                paginatedBins.map((bin) => (
                                    ...
                                    >
                                        ...
                                        <td className='px-6 py-4'>
                                            <div className='flex items-center gap-2'>
                                                {/* Edit button - ADMIN can edit all, SUPERVISOR can edit bins in assigned warehouse */}
                                                {(userRole === 'ADMIN' ||
                                                    (userRole ===
                                                        'SUPERVISOR' &&
                                                ...
                                                {/* Delete button - ADMIN can delete all, SUPERVISOR can delete in assigned warehouse (if empty) */}
                                                {(userRole === 'ADMIN' ||
                                                    (userRole ===
                                                        'SUPERVISOR' &&
                                                        currentUser?.warehouseId ===
